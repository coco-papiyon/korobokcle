...
func (m *WorkerManager) Submit(job domain.Job) error {
	...
	switch job.Kind {
	case domain.JobKindIssueDesign, domain.JobKindIssueImplementation, domain.JobKindPRReview, domain.JobKindPRAcceptance, domain.JobKindPRFeedback, domain.JobKindPRConflict:
	default:
